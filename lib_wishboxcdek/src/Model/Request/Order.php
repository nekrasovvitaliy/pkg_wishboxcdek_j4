...
use WishboxCdekSDK2\Traits\
{CommonTrait,
	Order\CommentOptionalTrait,
	Order\DeliveryPointOptionalTrait,
	Order\DeveloperKeyOptionalTrait,
	Order\ShipmentPointOptionalTrait,
	OrderTrait,
	TariffCodeTrait,
	TariffTrait,
	TypeOptionalTrait,
...
class Order extends Source
{
	 ...
	 */
	use CommentOptionalTrait;

	/**
	 * 6. Ключ разработчика (для разработчиков модулей)
	 */
	use DeveloperKeyOptionalTrait;
	 ...
	 */
	use ShipmentPointOptionalTrait;

	/**
	 * 8. Код офиса СДЭК (ПВЗ/постамата), на который будет доставлена посылка
	 * Не может использоваться одновременно с to_location
	 */
	use DeliveryPointOptionalTrait;
